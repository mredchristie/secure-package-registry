// Package httpserver provides a reusable HTTP server with graceful shutdown support.
package httpserver
...
// The component parameter is used as the zerolog component tag (e.g. "core-svc:external").
func New(component, addr string, handler http.Handler) *Server {
	return &Server{
		name: component,
		server: &http.Server{
			Addr:         addr,
