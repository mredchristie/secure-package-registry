-- This migration is derived from internal/gen/coredb/schema.sql
-- which is the single source of truth for the database schema.
-- For pre-MVP, this represents the full schema.
-- Post-MVP, use incremental migrations with ALTER statements.
